...
<body>
    ...
    <div class="row mb-3">
        <div class="col-12 mt-4">
            <h2 class="text-center mb-3" style="color: #2c3e50; font-weight: 700;">Registrar Crédito</h2>
        </div>
    </div>
            ...
            <form method="POST" action="" id="formCredito">
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="text" class="form-control-custom" id="cedula" name="cedula" placeholder="0-0000-0000" required onkeyup="ConsultarNombre(); soloNumeros(this);">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control-custom border-start-0" id="monto" name="monto" placeholder="0.00" step="0.01" min="0" required onkeyup="soloNumeros(this);">
                        </div>
                    </div>
                ...
                <div class="d-flex justify-content-end gap-3 mt-4">
                    ...
                    <button type="submit" name="btnRegistrarCredito" class="btn-form-primary">
