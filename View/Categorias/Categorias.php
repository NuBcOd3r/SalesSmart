...
<body>
    ...
    <div class="row mb-3">
        <div class="col-12 mt-4">
            <h2 class="text-center mb-3" style="color: #2c3e50; font-weight: 700;">Listado de Categorías</h2>
        </div>
        <div class="mb-3">
            <a class="btn text-white px-4 btn-custom-primary mt-1"
                href="RegistrarCategorias.php">
                <i class="fa-solid fa-plus me-2"></i>Registrar Categoría
            </a>
            <a class="btn text-white px-4 btn-custom-danger mt-1"
                href="CategoriasEliminadas.php">
                <i class="fa-solid fa-trash-can me-2"></i>Categorías Eliminadas
            </a>
        </div>
    </div>
                            ...
                            <td class="text-center align-middle">
                                <div class="action-buttons d-flex justify-content-center gap-3">
                                    ...
                                    <form method="POST" action="" style="margin:0;">
                                        ...
                                        <button type="submit" name="btnEliminarCategoria"
                                            title="Eliminar"
