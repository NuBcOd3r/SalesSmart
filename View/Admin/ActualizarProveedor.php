...
<div class="row mb-3">
    <div class="col-12 mt-4">
        <h2 class="text-center mb-3" style="color: #2c3e50; font-weight: 700;">Actualizar Proveedor</h2>
    </div>
</div>
        ...
        <form method="POST" action="" id="formProveedor" name="formProveedor">
            <div class="row">
                <div class="col-md-12 mb-4">
                    ...
                    <input type="text" class="form-control-custom" id="nombre" name="nombre" placeholder="Ingrese el nombre del proveedor" required>
                </div>
